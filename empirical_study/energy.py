...
# Load the dataset
df = pd.read_csv("data/energy.csv", header=None)
...
for i in range(10):
    ...
    if i == SAVE_RUN_ID:
        ...
        }).to_csv("data/split_indices_energy.csv", index=False)
    ...
    R, M_mean, M_std, _, _, _, _ = model.train(
        features=X_train,
        target=y_train,
...
# input_dimension = 20
# # max_rank = 50
# Total runtime for 10 runs: 57.00 seconds
# Mean RMSE: 0.49550474389401866, Standard Deviation of RMSE: 0.143182725282354
# Mean NLL : 1.5287726696278263, Standard Deviation of NLL: 0.27906834896739774
# Effective R: 10.1, std: 1.3
# ############################################################
